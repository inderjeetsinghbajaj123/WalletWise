        ...
        <section className="ww-hero-ref">
          <div className="ww-container ww-hero-ref-grid">
            ...
            >
              ...
              <motion.h1
                className="ww-hero-ref-title"
                variants={animation.fadeUp}
              >
                Make <span className="highlight-green">Planning</span> for{" "}
                <br />
                Student Life.
              </motion.h1>
                ...
                >
                  <defs>
                    ...
                    >
                      <stop
                        offset="0%"
                        style={{ stopColor: "#FB923C", stopOpacity: 0.1 }}
                      />
                      <stop
                        offset="100%"
                        style={{ stopColor: "#F59E0B", stopOpacity: 0.05 }}
                      />
                    </linearGradient>
                    <linearGradient
                      id="doodle-grad-green"
                      x1="0%"
                      y1="100%"
                      x2="100%"
                      y2="0%"
                    >
                      ...
                      <stop
                        offset="100%"
                        style={{ stopColor: "#34D399", stopOpacity: 0.05 }}
                      />
                    </linearGradient>
                  </defs>
                  <path
                    d="M480.5,189.5Q447,265,375,304Q303,343,223.5,313.5Q144,284,107.5,207.5Q71,131,154,88.5Q237,46,318.5,73.5Q400,101,457,132Q514,163,480.5,189.5Z"
                    fill="url(#doodle-grad-orange)"
                    transform="translate(50, 50) scale(0.9)"
                  />
                  <path
                    d="M417.5,268Q364,358,263.5,343Q163,328,110.5,238Q58,148,158.5,97.5Q259,47,345,106.5Q431,166,417.5,268Z"
                    fill="url(#doodle-grad-green)"
                  ...
                  >
                    ...
                    />
                    <path
                      d="M150 320 H 450 L 470 350 H 130 L 150 320 Z"
                      fill="white"
                      strokeWidth="3"
                    />
                    <path
                      d="M180 250 L 230 200 L 270 230 L 350 150"
                      stroke="#10B981"
                      strokeWidth="3"
                    />
                    <circle
                    ...
                    <g transform="translate(80, 100) rotate(-15)">
                      <path
                        d="M30 60 C 10 60, 10 10, 30 10 C 50 10, 50 0, 70 0 C 90 0, 90 10, 110 10 C 130 10, 130 60, 110 60 C 130 60, 130 110, 110 110 C 90 110, 90 120, 70 120 C 50 120, 50 110, 30 110 C 10 110, 10 60, 30 60 Z"
                        fill="white"
                      />
                      <path
                        d="M70 30 L 70 90 M 40 60 L 100 60"
                        stroke="#FB923C"
                        strokeWidth="4"
                      />
                      <circle
                    ...
                    <g transform="translate(420, 280) rotate(10)">
                      <path
                        d="M80 40 Q 80 0, 40 0 Q 0 0, 0 40 Q 0 80, 40 80 Q 60 80, 70 70 L 80 80 L 90 70 L 80 60 Q 100 40, 80 40 Z"
                        fill="white"
                      />
                      <rect
                        x="35"
                    ...
                    <path
                      d="M500 250 L 530 220 M 530 220 L 540 240 M 530 220 L 510 210"
                      stroke="#10B981"
                      strokeWidth="3"
                    />
                    <path
                      d="M40 40 L 45 55 L 60 60 L 45 65 L 40 80 L 35 65 L 20 60 L 35 55 Z"
                      fill="#F59E0B"
                      stroke="none"
                    />
                    <path
                      d="M550 350 L 555 365 L 570 370 L 555 375 L 550 390 L 545 375 L 530 370 L 545 365 Z"
                      fill="#10B981"
                      stroke="none"
                    />
                  </g>
        ...
        <section className="ww-section" id="about">
          <div className="ww-container">
            <div className="ww-text-block">
              ...
              <h2>
                Smart student finance tracking that <br /> explains the “why.”
              </h2>
          ...
          <div className="ww-container ww-grid-2">
            <div className="ww-content-left">
              ...
              <ul className="ww-check-list">
                ...
                <li>
                  <CheckCircle2 size={20} className="check-icon" />
                  <span>
                    <strong>Restrictive budgeting:</strong> Most tools aren't
                ...
                <li>
                  <CheckCircle2 size={20} className="check-icon" />
                  <span>
                    <strong>Anxiety about the future:</strong> "Can I afford
                    this?" shouldn't be a daily worry.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="ww-content-right">
              <div className="ww-visual-connected">
                ...
                >
                  <div className="icon-box ib-orange">
                    <Target size={18} />
                  </div>
        ...
        <section className="ww-section" id="features">
          <div className="ww-container">
            <div className="ww-section-header centered">
              ...
              <p>
                Smart automation and dashboards that turn anxiety into
                confidence.
              </p>
            </div>
                    ...
                    <div className="ww-bento-visual">
                      <div className="bar-group">
                        <div className="bar-bg">
                          <div className="bar-fill w-75"></div>
                        </div>
                        <div className="bar-bg">
